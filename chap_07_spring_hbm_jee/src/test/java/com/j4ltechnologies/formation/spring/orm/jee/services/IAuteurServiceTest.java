...
class IAuteurServiceTest {
	...
	private void populate() {
		Auteur claudeDelanoy = new Auteur("d.claude@aston.fr", "claude", "delanoy", LocalDate.of(1965, 8, 24));
		...
		Auteur raphaelGotter = new Auteur("g.raphael@aston.fr", "Raphaël", "Goetter", LocalDate.of(1976, 1, 2));
